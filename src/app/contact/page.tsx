  ...
  return (
    <div className="container mx-auto px-4 py-11">
      <div className="grid gap-12 lg:grid-cols-2">
        <div>
          <h2 className="mb-4 text-center text-2xl font-bold lg:text-3xl">Find Us Here</h2>
        ...
        <div>
          <h2 className="mb-4 text-center text-2xl font-bold lg:text-3xl">Contact Us</h2>
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              <Button type="submit" className="font-mono">Send Message</Button>
            </div>
            {status === "success" && (
      ...
      <div className="mb-4 mt-6 text-left">
        ...
        <div className="font-mono text-lg text-muted-foreground">
          <h2 className="mb-2 text-2xl font-bold text-black">Dr. Arjun Sharma</h2>
          ...
          <div className="text-left">
            <p className="mt-6 font-mono text-muted-foreground">arjun.sharma@pfw.edu</p>
